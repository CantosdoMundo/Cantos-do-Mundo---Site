...
export default function HeroOriginal() {
    return (
        <section className="relative h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-canto-da-terra via-canto-da-terra to-terracota">
            {/* Decorative Circle */}
            ...
            {/* Subtle Overlay */}
            <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-transparent to-black/10 z-10" />
            ...
            <div className="relative z-20 text-center px-4 max-w-4xl mx-auto flex flex-col items-center">
                ...
                <motion.p
                    ...
                    className="font-script text-2xl md:text-3xl text-duna/90 mb-6 max-w-2xl mx-auto drop-shadow-lg"
                >
                ...
                <motion.h1
                    ...
                    className="font-serif text-5xl md:text-7xl text-brisa mb-10 leading-tight drop-shadow-xl"
                >
                    Cada canto do mundo,
                    <br />
                    um novo você.
